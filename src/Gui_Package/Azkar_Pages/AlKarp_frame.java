 ...
 * @author AhmedTalal
 */
public class AlKarp_frame extends javax.swing.JFrame {
   ...
   int NumberOfAlZeker = 1;
    ...
    private void initComponents() {
        ...
        jTextPane2.setText("(لا إله إلا الله العظيم الحليم , لا إله إلا الله رب العرش العظيم \nلا إله إلا الله رب السموات ورب الارض ورب العرش الكريم)");
    ...
    private void Next_Button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Next_Button2ActionPerformed
        ...
        }else  if(NumberOfAlZeker < Integer.parseInt(Final_TextField1.getText()))
        {
             ...
             {
                jTextPane2.setText("(اللهم رحمتك ارجو فلا تكلني الي نفسي طرفه عين \n" +
"واصلح لي شاني كله  لا إله إلا انت)");
                Number_TextField.setText("1");
             ...
             {
                 jTextPane2.setText("                   (لا إله إلا انت سبحانك اني كنت من الظالمين)");
                Number_TextField.setText("1");
                Counter_TextField2.setText("");
                counter=0;
             }
             ...
             {
                jTextPane2.setText("                                    (الله الله ربي لا شريك به شيئا)");
                Number_TextField.setText("1");
                Counter_TextField2.setText("");
                counter=0;   
             }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlKarp_frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AlKarp_frame().setVisible(true);
            }
        });
    }
