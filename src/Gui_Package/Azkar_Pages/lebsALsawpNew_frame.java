 ...
 * @author AhmedTalal
 */
public class lebsALsawpNew_frame extends javax.swing.JFrame {
   ...
   int NumberOfAlZeker = 1;
    ...
    private void initComponents() {
        ...
        jTextPane2.setText("(اللهم لك الحمد انت كسوتنيه.واسالك من خيره \nوخير ما صنع له ,واعوذ بك من شره وشر ماصنع له)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lebsALsawpNew_frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new lebsALsawpNew_frame().setVisible(true);
            }
        });
    }
