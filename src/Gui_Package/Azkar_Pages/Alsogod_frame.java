 ...
 * @author AhmedTalal
 */
public class Alsogod_frame extends javax.swing.JFrame {
   ...
   int NumberOfAlZeker = 1;
    ...
    private void initComponents() {
        ...
        jTextPane2.setText("                                        (سبحان ربي الاعلي)");
        ...
        NumberAlzeker_TextField1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                NumberAlzeker_TextField1ActionPerformed(evt);
            }
        });
    ...
    private void Next_Button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Next_Button2ActionPerformed
        ...
        }else  if(NumberOfAlZeker < Integer.parseInt(Final_TextField1.getText()))
        {
             ...
             {
                jTextPane2.setText("                         (سبحانك اللهم ربنا وبحمدك اللهم اغفر لي)");
             ...
             {
                 jTextPane2.setText("                           (سبوح قدوس رب الملائكه والروح)");
                Number_TextField.setText("1");
                Counter_TextField2.setText("");
                counter=0;
             }
             ...
             {
                jTextPane2.setText("  (اللهم لك ركعت وبك امنت ولك اسلمت سجد وجهي للذي خلقه\n" +
                                           "وصوره وشقى سمعه وبصره تبارك الله احسن الخالقين)");
                Number_TextField.setText("1");
                Counter_TextField2.setText("");
                counter=0;   
             }
             ...
             {
                  jTextPane2.setText("                  (سبحان ذي الجبروت والملكوت والكبرياء والعظمة)");
                Number_TextField.setText("1");
                Counter_TextField2.setText("");
                counter=0;
             }
             ...
             {
                 jTextPane2.setText("             (اللهم اغفر لي ذنبي كله دقه وجله واوله واخره وعلانيه وسره )");
                Number_TextField.setText("1");
                Counter_TextField2.setText("");
                counter=0;
             }
             ...
             {
                   jTextPane2.setText("               (اللهم اني اعوذ برضاك من سخطك وبمعافاتك \n" +
                                    "من عقوبتك واعوذ بك منك لا احصي ثناء عليك انت \n" +
                                "كما اثنيت علي نفسك)");
                Number_TextField.setText("1");
                Counter_TextField2.setText("");
                counter=0;
    ...
    private void NumberAlzeker_TextField1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NumberAlzeker_TextField1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_NumberAlzeker_TextField1ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Alsogod_frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Alsogod_frame().setVisible(true);
            }
        });
    }
