 ...
 * @author AhmedTalal
 */
public class was_frame extends javax.swing.JFrame {
   ...
   int NumberOfAlZeker = 1;
    ...
    private void initComponents() {
        ...
        jTextPane2.setText("                                                     (يستعيذ بالله )");
    ...
    private void Next_Button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Next_Button2ActionPerformed
        ...
        }else  if(NumberOfAlZeker < Integer.parseInt(Final_TextField1.getText()))
        {
             ...
             {
                jTextPane2.setText("                           (ينتهي عما وسوس فيه)");
                Number_TextField.setText("1");
             ...
             {
                 jTextPane2.setText("                   (يقول امنت بالله ورسوله)");
                Number_TextField.setText("1");
                Counter_TextField2.setText("");
                counter=0;
             }
             ...
             {
                jTextPane2.setText("(يقول قوله تعالي : هو الاول والاخر والظاهر والباطن "
                        + "وهو بكل شئ عليم)");
                Number_TextField.setText("1");
                Counter_TextField2.setText("");
                counter=0;   
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(was_frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
