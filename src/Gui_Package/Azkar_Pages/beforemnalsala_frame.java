 ...
 * @author AhmedTalal
 */
public class beforemnalsala_frame extends javax.swing.JFrame {
   ...
   int NumberOfAlZeker = 1;
    ...
    private void initComponents() {
        ...
        jTextPane2.setText("\nاستغفر الله ثلاثا  اللهم انت السلام ومنك السلام تباركت يا ذا الجلال والاكرام\n  \n");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(NumberAlzeker_TextField1.getText().equals(Final_TextField1.getText()))
        {
    ...
    private void Next_Button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Next_Button2ActionPerformed
        ...
        }else  if(NumberOfAlZeker < Integer.parseInt(Final_TextField1.getText()))
        {
             ...
             {
                jTextPane2.setText("         (لا إله إلا الله وحده لاشريك له ’ له الملك وله الحمد \n" +
                                              "وهو علي كل شئ قدير : ثلاثا ’ اللهم لا مانع لما\n" +
                                         "اعطيت ولا معطي لما منعت ’ ولا ينفع ذا الجد منك الجد\n" +
                                                                                           ")");
                Number_TextField.setText("1");
             ...
             {
                 jTextPane2.setText("                 (لا إله إلا الله وحده لا شريك له ,له الملك وله الحمد \n" +
                                                           "وهو علي كل شئ قدير , لا حول ولا قوه إلابالله \n" +
                                                           "لا إاله إلا الله , ولا نعبد إلا إياه , له النعمه وله \n" +
                                                           "الفضل وله الثنا الحسن ,لا إله إلا الله مخلصين \n" +
             ...
             {
                jTextPane2.setText("(سبحان الله ,  والحمد لله , والله اكبر ->ثلاثا وثلاثين<-لا\n" +
...
"                                        يحيئ ويميت وهو علي كل شئ قدير ");
             ...
             {
                 jTextPane2.setText("                (اللهم اني اسالك علما نافعا ورزقا طيبا وعمل متقبلا)");
                 Number_TextField.setText("1");
                 Counter_TextField2.setText("");
                 counter = 0;
             }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(beforemnalsala_frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new beforemnalsala_frame().setVisible(true);
            }
        });
    }
