 ...
 * @author AhmedTalal
 */
public class between_sagteten_frame extends javax.swing.JFrame {
   ...
   int NumberOfAlZeker = 1;
    ...
    private void initComponents() {
        ...
        jTextPane2.setText("                  (رب اغفر لي , رب اغفر لي)");
    ...
    private void Next_Button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Next_Button2ActionPerformed
        ...
        }else  if(NumberOfAlZeker < Integer.parseInt(Final_TextField1.getText()))
        {
             ...
             {
                jTextPane2.setText("     ( اللهم اغفر لي , وارحمني , واهدني , واجبرني \n" +
"وعافني , وارزقني , وارفعني)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(between_sagteten_frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new between_sagteten_frame().setVisible(true);
            }
        });
    }
