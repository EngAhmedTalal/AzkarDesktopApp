 ...
 * @author AhmedTalal
 */
public class Enter_ALHmam_frame extends javax.swing.JFrame {
   ...
   int NumberOfAlZeker = 1;
    ...
    private void initComponents() {
        ...
        jTextPane2.setText("(بسم الله ]اللهم اني اعوذ بك من الخبث والخبائث])");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Enter_ALHmam_frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Enter_ALHmam_frame().setVisible(true);
            }
        });
    }
