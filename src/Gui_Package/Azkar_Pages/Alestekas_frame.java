 ...
 * @author AhmedTalal
 */
public class Alestekas_frame extends javax.swing.JFrame {
   ...
   int NumberOfAlZeker = 1;
    ...
    private void initComponents() {
        ...
        jTextPane2.setFont(new java.awt.Font("Tahoma", 1, 28)); // NOI18N
        jTextPane2.setText("   (الحمد لله الذي احيانا بعد ما اماتنا واليه النشور)");
    ...
    private void Next_Button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Next_Button2ActionPerformed
        ...
        {
             JOptionPane.showMessageDialog(null, "لا تضغط علي هذا الذرار الا ف حاله اكتمال عدد الذكر!", "ERROR", JOptionPane.WARNING_MESSAGE);
        ...
        }else  if(NumberOfAlZeker < Integer.parseInt(Final_TextField1.getText()))
        {
             ...
             {
                jTextPane2.setText("لا اله الا الله وحده لاشريك له له لملك وله الحمد وهو علي كل شي قدير \n" +
"سبحان الله والحمد لله ولا اله الا الله والله واكبر ولاحول ولاقوه الا بالله \n" +
"العلي العظيم .رب اغفر لي");
             ...
             {
                jTextPane2.setText("الحمد لله الذي عافاني في جسدي , ورد علي روحي , وأذن لي بذكره");
                Number_TextField.setText("1");
                Counter_TextField2.setText("");
                counter=0;
             }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Alestekas_frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Alestekas_frame().setVisible(true);
            }
        });
    }
