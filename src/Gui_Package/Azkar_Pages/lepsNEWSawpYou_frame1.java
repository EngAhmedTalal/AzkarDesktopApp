 ...
 * @author AhmedTalal
 */
public class lepsNEWSawpYou_frame1 extends javax.swing.JFrame {
   ...
   int NumberOfAlZeker = 1;
    ...
    private void initComponents() {
        ...
        jTextPane2.setText("             (تبلي ويخلف الله تعالي)");
    ...
    private void Next_Button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Next_Button2ActionPerformed
        ...
        }else  if(NumberOfAlZeker < Integer.parseInt(Final_TextField1.getText()))
        {
             ...
             {
                jTextPane2.setText("(البس جديدا وعش حميدآ ومت شهيدآ)");
                Number_TextField.setText("1");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lepsNEWSawpYou_frame1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new lepsNEWSawpYou_frame1().setVisible(true);
            }
        });
    }
