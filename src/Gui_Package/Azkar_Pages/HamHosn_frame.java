 ...
 * @author AhmedTalal
 */
public class HamHosn_frame extends javax.swing.JFrame {
   ...
   int NumberOfAlZeker = 1;
    ...
    private void initComponents() {
        ...
        jTextPane2.setText(" اللهم اني عبدك ابن عبدك ابن امتك ناصيتي بيدك ماض\n في حمك عادل في قضاؤك اسألك بكل اسم هو لك\nسميت به نفسك او انزلته في كتابك او علمته احد \nمن خلقك او استاثرته به في  علم الغيب عندك \nان تجعل القران الكريم ربيع قلبي ونور صدري \n      وجلاء حزني وذهاب همي");
    ...
    private void Next_Button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Next_Button2ActionPerformed
        ...
        }else  if(NumberOfAlZeker < Integer.parseInt(Final_TextField1.getText()))
        {
             ...
             {
                jTextPane2.setText("اللهم اني اعوذ بك من الهم والحزن والعجز\n" +
"والكسل والبخل والجبن وضلع الدين وغلبه الرجال");
                Number_TextField.setText("1");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HamHosn_frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HamHosn_frame().setVisible(true);
            }
        });
    }
