 ...
 * @author AhmedTalal
 */
public class Alrokoa_frame extends javax.swing.JFrame {
   ...
   int NumberOfAlZeker = 1;
    ...
    private void initComponents() {
        ...
        jTextPane2.setText("                                        (سبحان ربي العظيم)");
    ...
    private void Next_Button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Next_Button2ActionPerformed
        ...
        }else  if(NumberOfAlZeker < Integer.parseInt(Final_TextField1.getText()))
        {
             ...
             {
                jTextPane2.setText("                         (سبحانك اللهم ربنا وبحمدك اللهم اغفر لنا)");
             ...
             {
                jTextPane2.setText("            (اللهم لك ركعت وبك امنت ولك اسلمت وخشع لك سمعي \n" +
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Alrokoa_frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Alrokoa_frame().setVisible(true);
            }
        });
    }
