 ...
 * @author AhmedTalal
 */
public class go_out_masged_frame extends javax.swing.JFrame {
   ...
   int NumberOfAlZeker = 1;
    ...
    private void initComponents() {
        ...
        jTextPane2.setText("يبدا برجله اليسرى ويقول : بسم الله والصلاه والسلام علي رسول الله )\nاللهم اني اسالك من فضلك اللهم اعصمني من الشيطام الرجيم)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(go_out_masged_frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new go_out_masged_frame().setVisible(true);
            }
        });
    }
