 ...
 * @author AhmedTalal
 */
public class telawa_frame extends javax.swing.JFrame {
   ...
   int NumberOfAlZeker = 1;
    ...
    private void initComponents() {
        ...
        jTextPane2.setText("                    (سجد وجهي للذي خلقه , وشق سمعه وبصرة\n                      بحوله وقوته , فتبارك الله احسن الخالقين)");
            ...
            .addGroup(DeskPanelLayout.createSequentialGroup()
                ...
                .addGroup(DeskPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(DeskPanelLayout.createSequentialGroup()
                        ...
                        .addComponent(Next_Button2, javax.swing.GroupLayout.PREFERRED_SIZE, 84, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(DeskPanelLayout.createSequentialGroup()
                        .addGap(154, 154, 154)
    ...
    private void Next_Button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Next_Button2ActionPerformed
        ...
        }else  if(NumberOfAlZeker < Integer.parseInt(Final_TextField1.getText()))
        {
             ...
             {
                jTextPane2.setText("(اللهم اكتب لي بها عندك اجرأ , وضع عني بها وزرأ واجعلها لي \n" +
"عندك ذخٌرأ وتقبلها مني كما تقبلتها من عبدك داود)");
                Number_TextField.setText("1");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(telawa_frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new telawa_frame().setVisible(true);
            }
        });
    }
