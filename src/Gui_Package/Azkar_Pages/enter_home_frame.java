 ...
 * @author AhmedTalal
 */
public class enter_home_frame extends javax.swing.JFrame {
   ...
   int NumberOfAlZeker = 1;
    ...
    private void initComponents() {
        ...
        jTextPane2.setText("(بسم الله ولجنا وبسم الله خرجنا وعلي الله ربنا توكلنا ثم يسلم علي اهله)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(enter_home_frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new enter_home_frame().setVisible(true);
            }
        });
    }
