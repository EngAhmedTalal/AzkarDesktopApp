 ...
 * @author AhmedTalal
 */
public class GoodMorning_frame extends javax.swing.JFrame {
   ...
   int NumberOfAlZeker = 1;
    ...
    private void Next_Button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Next_Button2ActionPerformed
        ...
        }else  if(NumberOfAlZeker < Integer.parseInt(Final_TextField1.getText()))
        {
             ...
             {
                jTextPane2.setText("اصبحنا واصبح الملك لله ’ والحمد لله ’ لا إله إلا الله وحده لا شرك له\n" +
...
"                                 في النار وعذاب في القبر");
             ...
             {
                 jTextPane2.setText(" للهم بك اصبحنا وبك امسينا وبك نحيا وبك نموت واليك النشور");
                Number_TextField.setText("1");
                Counter_TextField2.setText("");
                counter=0;
             }
...
"                                السموات والارض ولا يؤوده حفظهما وهو العلي العظيم)");
             ...
             {
                   jTextPane2.setText("              اللهم اني اصبحت اشهدك اشهد حملة عرشك وملائكتك وجميع\n" +
"          انك انت الله لا إله إلا انت  وحدك لا شريك لك وان محمد عبده ورسوله");
             ...
             {
                 jTextPane2.setText(" اللهم ما اصبح بي من نعمه او بأحد من خلقك فمنك وحدك لا شريك لك فلك"
                         +                                                         "الحمد ولك الشكر");
                 Number_TextField.setText("1");
                 Counter_TextField2.setText("");
                 counter = 0;
...
"           شمالي ومن قوقي واعوذ بعظمتك ان اغتال من تحتي");
             ...
             {
                 jTextPane2.setText("اللهم عللم الغيب والشهاده فاطر السموات والارض رب كل شئ ومليكه \n" +
...
"         وان اقترف علي نفسي سوءا او اجره الي مسلم");
             ...
             {
                 jTextPane2.setText("                    اصبحنا واصبح الملك لله والحمد لله رب العالمين  اللهم \n" +
...
"                                        شر ما فيه وشر ما بعده");
             ...
             {
                 jTextPane2.setText(" اصبحنا علي فطره الاسلام وكلمه الاخلاص وعلي دين \n" +
...
"                               حنيفا مسلما ما كان من المشركين");
             ...
             {
                 jTextPane2.setText("                (سبحان الله وبحمده عدد خلقه ورضا نفسه وزنه عرشه مداد كلماته)");
                 Number_TextField.setText("3");
                 Counter_TextField2.setText("");
                 counter = 0;
             }
             ...
             {
                 jTextPane2.setText("                         (اللهم اني اسالك علما نافعا ورزقنا طيبا وعملا متقبلا)");
                 Number_TextField.setText("1");
                 Counter_TextField2.setText("");
                 counter = 0;
             }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GoodMorning_frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GoodMorning_frame().setVisible(true);
            }
        });
    }
