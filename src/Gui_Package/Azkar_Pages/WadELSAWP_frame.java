 ...
 * @author AhmedTalal
 */
public class WadELSAWP_frame extends javax.swing.JFrame {
   ...
   int NumberOfAlZeker = 1;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WadELSAWP_frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WadELSAWP_frame().setVisible(true);
            }
        });
    }
