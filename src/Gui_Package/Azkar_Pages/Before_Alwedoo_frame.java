 ...
 * @author AhmedTalal
 */
public class Before_Alwedoo_frame extends javax.swing.JFrame {
   ...
   int NumberOfAlZeker = 1;
    ...
    private void initComponents() {
        ...
        jTextPane2.setText("(أشهد ان لا اله الا الله وحده لا شريك له واشهد ان محمد آ عبده ورسوله)");
    ...
    private void Next_Button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Next_Button2ActionPerformed
        ...
        }else  if(NumberOfAlZeker < Integer.parseInt(Final_TextField1.getText()))
        {
             ...
             {
                jTextPane2.setText("(اللهم اجعلني من التوابين واجعلني من المتطهرين )");
                Number_TextField.setText("1");
             ...
             {
                 jTextPane2.setText("(سبحانك اللهم وبحمدك ,اشهدان لا اله الا انت استغفرك واتوب اليك)");
                Number_TextField.setText("1");
                Counter_TextField2.setText("");
                counter=0;
             }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Before_Alwedoo_frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Before_Alwedoo_frame().setVisible(true);
            }
        });
    }
