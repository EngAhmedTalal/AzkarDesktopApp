 ...
 * @author AhmedTalal
 */
public class enter_masged_frame extends javax.swing.JFrame {
   ...
   int NumberOfAlZeker = 1;
    ...
    private void initComponents() {
        ...
        Top_PanelLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, Top_PanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 1345, Short.MAX_VALUE)
        ...
        jTextPane2.setText("(يبدا برجله اليمنى ويقول : اعوذ بالله العظيم وبوجهه الكريم وسلطانه القديم من الشيطان الرجيم\n[بسم الله والصلاه علي رسول الله  اللهم افتح لي ابواب رحمتك])");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(enter_masged_frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new enter_masged_frame().setVisible(true);
            }
        });
    }
