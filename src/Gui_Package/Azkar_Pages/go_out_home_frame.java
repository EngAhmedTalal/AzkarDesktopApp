 ...
 * @author AhmedTalal
 */
public class go_out_home_frame extends javax.swing.JFrame {
   ...
   int NumberOfAlZeker = 1;
    ...
    private void initComponents() {
        ...
        Top_PanelLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, Top_PanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 1313, Short.MAX_VALUE)
        ...
        jTextPane2.setText("                        (بسم الله توكلت علي الله , ولا حول ولا قوه الا بالله)");
    ...
    private void Next_Button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Next_Button2ActionPerformed
        ...
        }else  if(NumberOfAlZeker < Integer.parseInt(Final_TextField1.getText()))
        {
             ...
             {
                jTextPane2.setText("اللهم اني اعوذ بك ان اضل او اٌضل او ازل او اٌزل و اظلم او اُظلم او اجهل او يجهل علي");
                Number_TextField.setText("1");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(go_out_home_frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new go_out_home_frame().setVisible(true);
            }
        });
    }
