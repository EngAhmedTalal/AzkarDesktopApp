 ...
 * @author AhmedTalal
 */
public class AlAzan_frame extends javax.swing.JFrame {
   ...
   int NumberOfAlZeker = 1;
    ...
    private void initComponents() {
        ...
        jTextPane2.setText("             (يقول مثل ما يقول المؤذن الا في \"حي علي الصلا وحي علي الفلاح\"\n                فيقول:لاحول والا قوه إلا بالله)  ");
    ...
    private void Next_Button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Next_Button2ActionPerformed
        ...
        }else  if(NumberOfAlZeker < Integer.parseInt(Final_TextField1.getText()))
        {
             ...
             {
                jTextPane2.setText("(يقول : وانا اشهد ان لا اله الا الله وحده لا شريك له وان محمد عبده ورسوله\n" +
"رضيت بالله ربا وبمحمد رسولا وبالاسلام دينا .يقول ذالك عقب تشهد المؤذن)");
                Number_TextField.setText("1");
             ...
             {
                 jTextPane2.setText("(يصلي علي النبي صلي الله عليه وسلم بعد فراغه من اجابه المؤذن)");
                Number_TextField.setText("1");
                Counter_TextField2.setText("");
                counter=0;
             }
             ...
             {
                jTextPane2.setText("(يقول : اللهم رب هذه الدعوه التامة والصلاه القائمه ات محمد الوسيله والفضيلة وابعثه\n" +
"مقاما محمودآ الذى وعدته انك لا تخلف المعاد )");
                Number_TextField.setText("1");
                Counter_TextField2.setText("");
                counter=0;   
             }
             ...
             {
                  jTextPane2.setText("(يدعو لنفسه بين الاذان والاقامه فإن الدعاء حينئذ لا يرد)");
                Number_TextField.setText("1");
                Counter_TextField2.setText("");
                counter=0;
             }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlAzan_frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AlAzan_frame().setVisible(true);
            }
        });
    }
