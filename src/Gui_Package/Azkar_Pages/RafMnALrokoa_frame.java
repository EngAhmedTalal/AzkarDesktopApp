 ...
 * @author AhmedTalal
 */
public class RafMnALrokoa_frame extends javax.swing.JFrame {
   ...
   int NumberOfAlZeker = 1;
    ...
    private void initComponents() {
        ...
        jTextPane2.setText("                                        (سمع الله لمن حمده)");
    ...
    private void Next_Button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Next_Button2ActionPerformed
        ...
        }else  if(NumberOfAlZeker < Integer.parseInt(Final_TextField1.getText()))
        {
             ...
             {
                jTextPane2.setText("                         (ربنا ولك الحمد .حمدا كثيرا طيبا مباركا فيه)");
                Number_TextField.setText("1");
             ...
             {
                 jTextPane2.setText("(ملْ السموات وملْ الارض وما بينهما وملء ما شئت من شئ بعد\n" +
"اهل الثنا والمجد احق ما قال العبد وكلنا لك عبدٌ. اللهم لا مانع لما \n" +
"اعطيت ولا معطي لما منعت و لاينفع ذا الجد منك الجد)");
                Number_TextField.setText("1");
                Counter_TextField2.setText("");
                counter=0;
             }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RafMnALrokoa_frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RafMnALrokoa_frame().setVisible(true);
            }
        });
    }
