 ...
 * @author AhmedTalal
 */
public class tshahod_frame extends javax.swing.JFrame {
   ...
   int NumberOfAlZeker = 1;
    ...
    private void initComponents() {
        ...
        jTextPane2.setText("(التحيات لله , والصلوات لله , والطيبات لله السلام عليك ايها النبي \nورحمه الله وبركاته , السلام عليك وعلي عبادك الله الصالحين\nاشهد ان لا اله الا الله وان محمد عبده ورسوله )");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tshahod_frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new tshahod_frame().setVisible(true);
            }
        });
    }
