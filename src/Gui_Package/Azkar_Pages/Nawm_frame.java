 ...
 * @author AhmedTalal
 */
public class Nawm_frame extends javax.swing.JFrame {
   ...
   int NumberOfAlZeker = 1;
    ...
    private void initComponents() {
        ...
        Top_PanelLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, Top_PanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 1240, Short.MAX_VALUE)
        ...
        jTextPane2.setText("(اعوذ بكلمات الله التامات وعقابه وشره عباده من همزات الشياطين وان يحضرون)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Nawm_frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Nawm_frame().setVisible(true);
            }
        });
    }
